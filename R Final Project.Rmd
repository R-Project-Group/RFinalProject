...
5. Unsurprisingly, given the backdrop of this project, African Americans were killed at the highest rates relative to their population. x, and x were the next two, at lower rates. x faced the lowest rate of police killings.  
...
uswhitedeaths/uswhitepop*10000
usblackdeaths/usblackpop*10000
ushispanicdeaths/ushispanicpop*10000
usasiandeaths/usasianpop*10000
...
plot(x = killdata_raceanalysis$blacksRatio, 
     ...
     cex  = 0.8,    # size
     col  = "blue", # color 
     xlab = "Black Killings per 10K Black Population",  # x-axis
     ylab = "Overall Killings per 10K General Population",  # y-axis 
     main = "Comparison of Killings/10K Population by County",
     xlim=c(0,3),
     ylim=c(0,1),
     abline(coef = c(0,1)))
