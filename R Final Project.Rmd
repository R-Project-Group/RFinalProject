...
```
On a national level, there are clear racial disparities among the per capita rate of police killings. When looking at the number of killings of a particular race per 10K population of that race, we can see that black Americans are killed at over 2x the rate of white Americans. Those of Hispanic descent are killed about 1/3 higher rate
